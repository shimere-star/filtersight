...
# ---------------------------------------------------------------------------
@app.post("/admin/backfill-dry-run")
async def backfill_dry_run(request: Request):
        ...
        try:
            ...
            if len(active_subscriptions) == 1:
                results.append({
                    ...
                    "stripe_subscription_id": active_subscriptions[0].id,
                })
    ...
    return {
        ...
        "would_update_count": len(results),
        "skipped": skipped,
